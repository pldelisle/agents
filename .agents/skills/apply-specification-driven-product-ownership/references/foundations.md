...
- Require a bounded `software_engineer` refinement pass using `$apply-specification-driven-software-engineering` before implementation-bound work becomes Ready.
