...
1. Document control and decision summary
2. Product Goal, evidence, and scope
3. Behavioral specification and quality attributes
4. Artifact governance and external boundaries
5. Engineering refinement and parallel delivery
6. Traceability and readiness
...
strategic_source: <artifact path/identifier and exact approved revision>
...
approved_by: <accountable approver or unapproved>
...
- **Specification baseline:** <revision, approval state, authority/persistence model, and rigor lane>
...
| Requirement | Observable obligation | Source / outcome | Verification class |
|---|---|---|---|
| REQ-1 | <necessary, singular, implementation-free obligation> | <goal, policy, evidence, or decision> | <test, analysis, inspection, demonstration, or measurement> |

### Rules

| Rule | Parent requirement | Behavioral rule | Rationale/source |
|---|---|---|---|
| RULE-1 | REQ-1 | <singular, implementation-free, verifiable rule> | <policy, evidence, or decision> |
...
|---|---|---|---|---|
| EX-2 | RULE-2 | <conditions> | <event> | <outcome> |
...
|---|---|---|---|
| NFR-1 | <performance, reliability, accessibility, etc.> | <objective threshold> | <conditions and method> |

## Artifact governance

- **Constitution/shared instructions:** <path and revision>
- **Strategic source:** <path/ID and approved revision>
- **Feature spec:** <this path and revision>
- **Derived plan/contracts/tasks:** <paths and revisions, or not yet authorized>
- **Generated boundaries:** <authoritative source, generator, generated paths, extension points>
- **Change authority:** <who can approve product-intent changes>
- **Change protocol:** <increment/supersede, impact analysis, rebaseline, evidence rerun>
- **Expiry/graduation gate:** <required for spec-first or exploratory packets>
...
| Product Goal/outcome | Requirement | Rule/NFR | Acceptance example | Plan/task link | Planned verification | Status |
|---|---|---|---|---|---|---|
| <goal/outcome> | REQ-1 | RULE-1 | EX-1 | <engineering-owned or not yet planned> | <condition/method> | <covered/partial/contradicted/blocked> |

### Backward traceability

List any planned task, contract, changed surface, or test with no upstream requirement.
Do not approve untraced scope merely because it appears useful.
...
- [ ] Requirements, rules, NFRs, examples, decisions, and open questions have stable IDs.
...
- [ ] Authority, persistence, rigor, revision, approval, lineage, and change protocol are explicit.
- [ ] Forward traceability has no unowned in-scope gap; backward traceability has no unapproved scope.
- [ ] Cross-artifact contradictions are resolved at the owning source before implementation.
