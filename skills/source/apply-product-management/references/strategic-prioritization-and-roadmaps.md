...
9. **Opportunity cost:** Which valuable alternative, existing-user need, or strategic capability will wait?
10. **Downside and reversibility:** What happens if the hypothesis is wrong, and can the decision be reversed?
