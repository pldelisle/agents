...
description: Apply Product Owner accountability to define Product Goals, question engineers, refine and order the Linear backlog through MCP, split epics, write detailed story specifications and acceptance examples, determine readiness, plan parallel delivery waves, and manage feedback. Use for Product Goals, Linear issues or projects, backlog refinement or grooming, user stories, acceptance criteria, specification-driven development, story splitting, backlog ordering, dependency mapping, parallel workflow planning, and Product Owner-to-engineer handoffs. Do not use for engineering implementation or developer-owned sizing.
---
...
9. Linear issue identifiers, synchronization status, verified mutations, and any pending or failed write.
