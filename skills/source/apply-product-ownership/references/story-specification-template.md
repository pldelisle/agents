...
issue_tracker_issue: <team-key-number>
issue_tracker_url: <canonical issue-tracker issue URL>
issue_tracker_synced_revision: <revision last verified in the issue tracker>
...
- **Issue-tracker synchronization:** <verified at revision | local draft only | pending authorized mutation | failed with reason>
...
- [ ] The issue and its verified synchronized revision are recorded before implementation handoff.
- [ ] Dependencies and risks have owners and consequences.
- [ ] Engineering evidence appropriate to the risk is recorded and material findings are dispositioned.
